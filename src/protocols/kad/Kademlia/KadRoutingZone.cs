...
namespace Kademlia
{
    ...
    public interface KadRoutingZone
    {
        ...
        bool OnBigTimer();
        void OnSmallTimer();
        bool Add(KadUInt128 uID, uint uIP, UInt16 uUDPPort,
            UInt16 uTCPPort, byte uVersion,
            KadUDPKey cUDPKey,
            ref bool bIPVerified,
            bool bUpdate,
            bool bFromNodesDat, bool bFromHello);
        bool AddUnfiltered(KadUInt128 uID, uint uIP, UInt16 uUDPPort,
            UInt16 uTCPPort, byte uVersion,
        ...
        bool VerifyContact(KadUInt128 uID, uint uIP);
        KadContact GetContact(KadUInt128 uID);
        KadContact GetContact(uint uIP, UInt16 nPort, bool bTCPPort);
        ...
        void GetClosestTo(uint uMaxType, KadUInt128 uTarget,
            KadUInt128 uDistance, uint uMaxRequired,
