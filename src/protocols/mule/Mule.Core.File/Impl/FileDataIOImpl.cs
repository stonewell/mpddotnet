...
{
    abstract class FileDataIOImpl : MuleBaseObjectImpl, FileDataIO
    {
        #region Fields
        ...
        public void ReadUInt128(ref Kademlia.KadUInt128 pVal)
        {
        ...
        public void WriteUInt16(UInt16 nVal)
        {
            binary_writer_.Write(nVal);
        }
        ...
        public void WriteUInt128(Kademlia.KadUInt128 pVal)
        {
