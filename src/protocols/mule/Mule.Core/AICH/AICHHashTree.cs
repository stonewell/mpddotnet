...
namespace Mule.Core.AICH
{
    public interface AICHHashTree
    {
        ...
        void SetBlockHash(ulong nSize, ulong nStartPos, AICHHashAlgo pHashAlg);

        bool ReCalculateHash(AICHHashAlgo hashalg, bool bDontReplace);

        bool VerifyHashTree(AICHHashAlgo hashalg, bool bDeleteBadTrees);
