...
namespace Mule.Core
{
    ...
    {
        public static void PreparePacketForTags(this KadByteIO pbyPacket, KnownFile pFile)
        {
        }
        ...
        public bool SaveHashSet(this KnownFile knownFile)
        {
        ...
        public bool LoadHashSet(this KnownFile knowFile)
        {
            if (Status != AICHStatusEnum.AICH_HASHSETCOMPLETE)
            {
