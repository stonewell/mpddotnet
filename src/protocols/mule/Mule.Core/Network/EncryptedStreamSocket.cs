...
namespace Mule.Core.Network
{
    public interface EncryptedStreamSocket
    {
        ...
        uint RealReceivedBytes { get; }
        bool IsObfusicating { get; }

        bool IsServerCryptEnabledConnection { get; }

        byte DbgByEncryptionSupported { get; set; }
        byte DbgByEncryptionRequested { get; set; }
        byte DbgByEncryptionMethodSet { get; set; }
    }
}
